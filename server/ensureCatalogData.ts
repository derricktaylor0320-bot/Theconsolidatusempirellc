...
const EXTRA_ACCESSORY_PRODUCTS: {
...
}[] = [
  {
    ...
    // Etsy custom-logo checkout $22.40 (sale) → retail $35. Shipping calculated by Etsy at fulfill time.
    priceCents: 3500,
    meta: {
      category: "Bags",
      productType: "accessory",
