...
const ALL_PRODUCTS = [
  ...
  // ELEMENTS — VITAMIN SUPPLEMENTS (flat $25, 60 count, no logo customization)
  {
    name: 'BCAA Complex',
    description: 'Khomplete Khemistri Elements BCAA Complex — branched-chain amino acids to support muscle recovery, endurance, and lean-muscle maintenance. 60 count.',
    price: 2500,
    metadata: { category: 'Elements', productType: 'elements', sortOrder: '100', imageUrl: '/assets/kk_elements_bcaa.png', customize: 'none' }
  },
  {
    name: 'Creatine Monohydrate',
    description: 'Khomplete Khemistri Elements Creatine Monohydrate — pure creatine to support strength, power output, and workout performance. 60 count.',
    price: 2500,
    metadata: { category: 'Elements', productType: 'elements', sortOrder: '101', imageUrl: '/assets/kk_elements_creatine.png', customize: 'none' }
  },
  {
    name: 'Organic Beetroot',
    description: 'Khomplete Khemistri Elements Organic Beetroot — supports healthy circulation, stamina, and natural energy. 60 count.',
    price: 2500,
    metadata: { category: 'Elements', productType: 'elements', sortOrder: '102', imageUrl: '/assets/kk_elements_beetroot.png', customize: 'none' }
  },
  {
    name: 'L-Arginine',
    description: 'Khomplete Khemistri Elements L-Arginine — supports healthy blood flow, circulation, and workout pump. 60 count.',
    price: 2500,
    metadata: { category: 'Elements', productType: 'elements', sortOrder: '103', imageUrl: '/assets/kk_elements_larginine.png', customize: 'none' }
  },
  {
    name: 'Sea Moss',
    description: 'Khomplete Khemistri Elements Sea Moss — nutrient-rich sea moss to support immunity, thyroid health, and overall wellness. 60 count.',
    price: 2500,
    metadata: { category: 'Elements', productType: 'elements', sortOrder: '104', imageUrl: '/assets/kk_elements_seamoss.png', customize: 'none' }
  },
  {
    name: 'COQ10',
    description: 'Khomplete Khemistri Elements COQ10 — Coenzyme Q10 to support heart health, cellular energy, and antioxidant protection. 60 count.',
    price: 2500,
    metadata: { category: 'Elements', productType: 'elements', sortOrder: '105', imageUrl: '/assets/kk_elements_coq10.png', customize: 'none' }
  },
  {
    name: 'Turmeric w/ BioPerine',
    description: 'Khomplete Khemistri Elements Turmeric with BioPerine — black pepper extract for enhanced absorption; supports joint comfort and a healthy inflammatory response. 60 count.',
    price: 2500,
    metadata: { category: 'Elements', productType: 'elements', sortOrder: '106', imageUrl: '/assets/kk_elements_turmeric.png', customize: 'none' }
  },
  {
    name: 'Vitamin K2 + D3',
    description: 'Khomplete Khemistri Elements Vitamin K2 + D3 — supports bone strength, immune health, and healthy calcium absorption. 60 count.',
    price: 2500,
    metadata: { category: 'Elements', productType: 'elements', sortOrder: '107', imageUrl: '/assets/kk_elements_k2d3.png', customize: 'none' }
  },
  {
    name: 'Magnesium Glycinate',
    description: 'Khomplete Khemistri Elements Magnesium Glycinate — highly absorbable magnesium to support relaxation, restful sleep, and muscle function. 60 count.',
    price: 2500,
    metadata: { category: 'Elements', productType: 'elements', sortOrder: '108', imageUrl: '/assets/kk_elements_magnesium.png', customize: 'none' }
  },
  {
    name: 'Ashwagandha & Black Pepper',
    description: 'Khomplete Khemistri Elements Ashwagandha & Black Pepper — black pepper for enhanced absorption; supports stress relief, balance, and vitality. 60 count.',
    price: 2500,
    metadata: { category: 'Elements', productType: 'elements', sortOrder: '109', imageUrl: '/assets/kk_elements_ashwagandha.png', customize: 'none' }
  },
  // VINTAGE BALTIMORE
  {
