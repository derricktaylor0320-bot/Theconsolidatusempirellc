...
test("six holistic sea moss gel SKUs are defined", () => {
  assert.equal(SEA_MOSS_GELS.length, 6);
...
test("sea moss gel descriptions mention holistic wellness", () => {
  const desc = seaMossGelDescription(SEA_MOSS_GELS[0]);
