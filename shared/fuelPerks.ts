/**
 * FR2P Fuel Rewards — standalone program config (mirrors The FR2P Club /fuel-rewards).
 */
export type FuelPerksTierId = "member" | "starter" | "pro" | "elite";
...
export type FuelPerksTier = {
  ...
  potentialCommissionLabel: string;
  potentialCommissionDetail: string;
  vsTierBelow: string | null;
  vsTierAbove: string | null;
  monthlyIncludes: string[];
  annualIncludes: string[];
  features: string[];
  featured: boolean;
  hasMarketingBackOffice: boolean;
  isPaidTier: boolean;
  /** Paid tiers only — monthly subscription in dollars */
  monthlyFee?: number;
...
export type FuelPerksFeatureGuide = {
  id: string;
  title: string;
  subtitle: string;
  steps: string[];
...
export type FuelPerksMarketingMaterial = {
  id: string;
  title: string;
  description: string;
  category: string;
...
export const HIHELLO_APP_STORE_URL =
  "https://apps.apple.com/us/app/hihello-digital-business-card/id1453874447";
export const HIHELLO_GOOGLE_PLAY_URL =
  "https://play.google.com/store/apps/details?id=me.hihello.mobile";
export const GOTPRINT_URL = "https://www.gotprint.com";
export const VISTAPRINT_URL = "https://www.vistaprint.com";

export const FUEL_PERKS_PROGRAM_TYPE =
...
export const FUEL_PERKS_FEATURE_GUIDES: FuelPerksFeatureGuide[] = [
  {
    ...
    proTip:
      "Think of the fuel pool like a shared subscription fund — the more active partners in the program, the more the pool can support affiliate payouts.",
  },
  {
    ...
    proTip:
      "Focus on quality referrals who will stay active. One loyal referral paying monthly beats ten signups who cancel.",
  },
  {
    id: "qr-marketing",
    ...
    proTip:
      "Position the QR at eye level where drivers stand while filling up — not on the ground or behind equipment.",
  },
  {
    id: "car-magnets",
    ...
    externalLinks: [{ label: "Order at VistaPrint", href: VISTAPRINT_URL }],
    proTip:
      "Use weather-resistant magnetic signs rated for outdoor use. Remove and reapply monthly to protect your paint.",
  },
  {
    ...
    marketingMaterialId: "pump-qr-flyer",
    proTip:
      "Start with stations you already visit regularly. Familiar faces get better responses than cold walk-ins.",
  },
  {
    ...
    proTip:
      "Set your referral link as the primary action on your HiHello card so every scan goes straight to your signup page.",
  },
  {
    id: "print-materials",
    ...
    proTip:
      "Save your info in the Marketing Back Office first — then every template is one click away from being print-ready.",
  },
];

export const FUEL_PERKS_MARKETING_MATERIALS: FuelPerksMarketingMaterial[] = [
  {
    id: "fuel-business-card",
    title: "Fuel Rewards Business Card",
    description:
      "Professional card for gas station partnerships — add your HiHello QR so drivers scan at the pump.",
    category: "Print Ready",
    printNote:
      "Hand to gas station managers when asking to display your QR code. Glossy finish recommended.",
  },
  {
    id: "fuel-postcard",
    title: "Fuel Savings Postcard",
    description:
      "4×6 postcard explaining fuel rewards savings — perfect for windshield drops and direct mail.",
    category: "Postcard",
    printNote:
      "Order at GotPrint.com — postcards starting at $49 for a professional run. Great for local campaigns.",
  },
  {
    id: "pump-qr-flyer",
    title: "Gas Pump QR Sign",
    description:
      "Bold sign template for gas pump displays — partner with station owners to put your QR where drivers wait.",
    category: "Field Marketing",
    printNote:
      "Print on weather-resistant material. Ask the station manager for permission before placing on pumps.",
  },
  {
    id: "car-magnet-guide",
    title: "Car Magnet & Mobile Marketing",
    description:
      "Use this template for vehicle magnets — turn every drive into a rolling advertisement with your QR code.",
    category: "Field Marketing",
    printNote:
      "Order custom car magnets through VistaPrint (bulk orders) or local sign shops. Add your HiHello QR.",
  },
];

export const FUEL_PERKS_TIER_COMPARISON = [
...
export const FUEL_PERKS_INCOME_STEPS = [
  {
    step: "1",
    title: "Share Your Link",
    desc:
      "Send your personal Fuel Rewards referral link by text, email, social media, or QR code. Every signup through your link is tracked to you.",
  },
  {
    step: "2",
    title: "Market Locally",
    desc:
      "Print business cards and postcards. Ask gas station managers if you can display your QR sign on their pumps. Add a car magnet with your QR.",
  },
  {
    step: "3",
    title: "Potential Recurring Commissions",
    desc:
      "Each active referral who pays their subscription may generate potential recurring commissions for you — based on your tier's commission share. Higher tiers = higher potential recurring percentage.",
  },
] as const;

export const FUEL_PERKS_STATION_PLAYBOOK = [
  "Visit a local gas station and ask to speak with the manager or business owner.",
...
export const FUEL_PERKS_TIERS: FuelPerksTier[] = [
  {
    ...
    annualCost: "$0",
    billingNote:
      "Included with active The FR2P Club membership — no additional monthly fee.",
    description:
      "Get started with fuel savings and your personal referral link — included free with any active The FR2P Club membership.",
    earnDescription:
  ...
  },
  {
    ...
    annualCost: "$239.88",
    billingNote:
      "Billed $19.99 every month · $239.88 if paid monthly for 12 months. Cancel anytime.",
    description:
      "Your entry into Fuel Rewards affiliate marketing — referral tools, fuel savings, and starter marketing materials every month.",
    earnDescription:
  ...
  },
  {
    ...
    annualCost: "$359.88",
    billingNote:
      "Billed $29.99 every month · $359.88 if paid monthly for 12 months. Includes Marketing Back Office.",
    description:
      "Full Marketing Back Office every month — business cards, postcards, HiHello digital QR card, gas pump signs, and print vendor guides.",
    earnDescription:
  ...
  },
  {
    ...
    annualCost: "$479.88",
    billingNote:
      "Billed $39.99 every month · $479.88 if paid monthly for 12 months. Highest potential recurring commission rate.",
    description:
      "The ultimate Fuel Rewards partner package — everything in Pro plus car magnets, station toolkit, and the highest potential recurring commission rate.",
    earnDescription:
...
export const FUEL_PERKS_PAID_TIERS = FUEL_PERKS_TIERS.filter((t) => t.isPaidTier);
...
export function getDefaultFuelPerksTier(): FuelPerksTier {
  return (
    getFuelPerksTierById(FUEL_PERKS_DEFAULT_TIER_ID) ?? FUEL_PERKS_TIERS[2]
  );
}
...
export function formatFuelPerksPriceRange(): string {
  const fees = FUEL_PERKS_PAID_TIERS.map((t) => t.monthlyFee!);
  const low = Math.min(...fees);
  const high = Math.max(...fees);
  return `$${low.toFixed(2)}–$${high.toFixed(2)}/mo`;
}

export function getFuelPerksProgramConfig() {
  return {
    platform: FUEL_PERKS_PLATFORM,
    programType: FUEL_PERKS_PROGRAM_TYPE,
    payoutExplainer: FUEL_PERKS_PAYOUT_EXPLAINER,
    tiers: FUEL_PERKS_TIERS,
    paidTiers: FUEL_PERKS_PAID_TIERS,
    featureGuides: FUEL_PERKS_FEATURE_GUIDES,
    marketingMaterials: FUEL_PERKS_MARKETING_MATERIALS,
    tierComparison: FUEL_PERKS_TIER_COMPARISON,
    incomeSteps: FUEL_PERKS_INCOME_STEPS,
    stationPlaybook: FUEL_PERKS_STATION_PLAYBOOK,
    links: {
      hiHelloAppStore: HIHELLO_APP_STORE_URL,
      hiHelloGooglePlay: HIHELLO_GOOGLE_PLAY_URL,
      gotPrint: GOTPRINT_URL,
      vistaPrint: VISTAPRINT_URL,
    },
  };
}
