...
const allLogos: Record<string, { src: string; alt: string; color: string; section: string }> = {
  "100": { src: logoGold3D, alt: "Gold 3D Emblem", color: "Gold 3D", section: "1st Generation" },
  "101": { src: logoGoldWhite, alt: "Gold & White Emblem", color: "Gold & White", section: "1st Generation" },
  "102": { src: logoBlackWhite, alt: "Classic Black & White", color: "Black & White", section: "1st Generation" },
  "103": { src: logoBWInverted, alt: "Inverted Black & White", color: "Inverted B&W", section: "1st Generation" },
  "104": { src: logoRedBlack, alt: "Red & Black Strike", color: "Red & Black", section: "1st Generation" },
  "105": { src: logoBlueWhite, alt: "Royal Blue Emblem", color: "Royal Blue", section: "1st Generation" },
  "106": { src: logoLightBlue, alt: "Sky Blue Emblem", color: "Sky Blue", section: "1st Generation" },
  "107": { src: logoPinkBlack, alt: "Neon Pink Emblem", color: "Neon Pink", section: "1st Generation" },
  "108": { src: logoGreyWhite, alt: "Slate Grey Emblem", color: "Slate Grey", section: "1st Generation" },
  "109": { src: logoForestGreen, alt: "Forest Green Emblem", color: "Forest Green", section: "1st Generation" },
  "110": { src: logoDeepPurple, alt: "Deep Purple Emblem", color: "Deep Purple", section: "1st Generation" },
  "111": { src: logoBlackGoldCircle, alt: "Black & Gold Emblem", color: "Black & Gold", section: "1st Generation" },
  "112": { src: logoOrange, alt: "Orange Emblem", color: "Orange", section: "1st Generation" },
  "113": { src: logoBrownGold, alt: "Brown & Gold Emblem", color: "Brown & Gold", section: "1st Generation" },
  "114": { src: logoTeal, alt: "Teal Emblem", color: "Teal", section: "1st Generation" },
  "115": { src: logoLimeGreen, alt: "Lime Green Emblem", color: "Lime Green", section: "1st Generation" },
  "116": { src: logoCircleText, alt: "Circular Text Logo", color: "Circle Text", section: "1st Generation" },
  "117": { src: medallionCorePrinciples, alt: "10 Core Principles Medallion", color: "Core Principles Medallion", section: "1st Generation" },
  "118": { src: badgeBlueValues, alt: "Blue & Gold Values Crest - Friendship, Trust, Harmony", color: "Blue Values Crest", section: "1st Generation" },
  "119": { src: shieldBlueGold, alt: "Royal Blue & Gold Crest", color: "Royal Blue & Gold", section: "1st Generation" },
  "120": { src: crestBlueValuesSwords, alt: "Khomplete Khemistri Apparel Crest - Unity, Strength, Brotherhood, Entrepreneurship, Harmony", color: "Blue Apparel Crest", section: "1st Generation" },
  "121": { src: shieldGoldBrown, alt: "Classic Gold Crest", color: "Classic Gold", section: "1st Generation" },
  "122": { src: shieldSilver, alt: "Silver Elite Crest", color: "Silver Elite", section: "1st Generation" },
  "123": { src: shieldCyanGold, alt: "Cyan & Gold Crest", color: "Cyan & Gold", section: "1st Generation" },
  "124": { src: shieldBlackWhite, alt: "Monochrome Crest", color: "Monochrome", section: "1st Generation" },
  "125": { src: badgeBrownGoldOrnate, alt: "Brown & Gold Ornate Crest", color: "Brown & Gold Ornate", section: "1st Generation" },
  "126": { src: badgePurpleOrnate, alt: "Purple Ornate Crest", color: "Purple Ornate", section: "1st Generation" },
  "127": { src: badgeNavySilver, alt: "Navy & Silver Crest", color: "Navy & Silver", section: "1st Generation" },
  "128": { src: badgePurpleSwords, alt: "Purple with Swords", color: "Purple Swords", section: "1st Generation" },
  "129": { src: badgeGreenSwords, alt: "Green with Swords", color: "Emerald Swords", section: "1st Generation" },
  "130": { src: badgeRedGoldSwords, alt: "Red & Gold with Swords", color: "Red & Gold Swords", section: "1st Generation" },
  "131": { src: crestGoldApparel, alt: "Khomplete Khemistri Apparel Gold Crest", color: "Gold Apparel Crest", section: "1st Generation" },
  "132": { src: kkmgEagleShield, alt: "KKMG LLC Eagle Shield of Honor", color: "KKMG LLC Shield", section: "1st Generation" },
  "200": { src: honorAllGold, alt: "The Golden Eagle Shield", color: "All Gold", section: "2nd Generation" },
  "201": { src: honorNavyGold, alt: "Navy & Gold Eagle Shield", color: "Navy & Gold", section: "2nd Generation" },
  "202": { src: honorSilverGold, alt: "Silver & Gold Eagle Shield", color: "Silver & Gold", section: "2nd Generation" },
  "203": { src: honorBlackGold, alt: "Black & Gold Eagle Shield", color: "Black & Gold", section: "2nd Generation" },
  "204": { src: honorMaroonGold, alt: "Maroon & Gold Eagle Shield", color: "Maroon & Gold", section: "2nd Generation" },
  "205": { src: honorNavySilver, alt: "Navy & Silver Eagle Shield", color: "Navy & Silver", section: "2nd Generation" },
  "206": { src: honorBrownGold, alt: "Brown & Gold Eagle Shield", color: "Brown & Gold", section: "2nd Generation" },
  "207": { src: honorPurpleGold, alt: "Purple & Gold Eagle Shield", color: "Purple & Gold", section: "2nd Generation" },
  "208": { src: honorWhiteGold, alt: "White & Gold Eagle Shield", color: "White & Gold", section: "2nd Generation" },
  "209": { src: logoAccessoriesEagle, alt: "Khomplete Khemistri Accessories Eagle", color: "Accessories Eagle", section: "2nd Generation" },
  "210": { src: logoCrossedSwords, alt: "Crossed Swords with Khomplete Khemistri", color: "Crossed Swords", section: "2nd Generation" },
  "211": { src: logoKKShieldSwords, alt: "KK Shield with Swords", color: "KK Shield & Swords", section: "2nd Generation" },
  "212": { src: logoKKACrossedSwords, alt: "KKA Crossed Swords Logo", color: "KKA Swords", section: "2nd Generation" },
  "213": { src: logoBeddingLuxury, alt: "Khomplete Khemistri Accessories - Sleep and Dream in Luxury", color: "Bedding Luxury", section: "2nd Generation" },
  "214": { src: logoKKAShield, alt: "KKA Shield with Eagle - Khomplete Khemistri Apparel", color: "KKA Shield", section: "2nd Generation" },
  "300": { src: compassKKApparel, alt: "Khomplete Khemistri Apparel Compass", color: "KK Apparel Compass", section: "3rd Generation" },
  "301": { src: compassKMG1, alt: "KKMG LLC Compass", color: "KKMG LLC Compass", section: "3rd Generation" },
  "302": { src: compassKMG2, alt: "KKMG LLC Compass II", color: "KKMG LLC Compass II", section: "3rd Generation" },
  "303": { src: compassSunburst, alt: "Khomplete Khemistri Apparel Sunburst Emblem", color: "Apparel Sunburst", section: "3rd Generation" },
};
