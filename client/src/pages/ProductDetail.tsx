      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 max-w-6xl mx-auto">
        ...
        <div className="relative aspect-square overflow-hidden rounded-xl bg-muted shadow-2xl">
          <img
            src={product.imageUrl}
            alt={product.title}
            className={`${product.productType === "vintage" || product.imageUrl?.includes("kk_sneaker") || product.imageUrl?.includes("kk_air_genesis") || product.imageUrl?.includes("kk_air_spectrum") || product.imageUrl?.includes("kk_air_nitrogen") || product.imageUrl?.includes("kk_signature_crest") || product.imageUrl?.includes("kk_crest_2_high") || product.imageUrl?.includes("kk_monarch_vanguard") || product.imageUrl?.includes("kk_sovereign_runner") || product.imageUrl?.includes("kk_classic_leather_foundation") || product.imageUrl?.includes("kk_tundra_chukka") || product.imageUrl?.includes("kk_tundra_fur_chukka") || product.imageUrl?.includes("kk_canvas_essential") || product.imageUrl?.includes("kk_classic_white_high_tops") || product.imageUrl?.includes("kk_black_gold_high_tops") || product.imageUrl?.includes("kk_custom_logo_jeans") || product.imageUrl?.includes("kk_custom_logo_shorts") || product.imageUrl?.includes("kk_custom_logo_bikini") || product.imageUrl?.includes("kk_branded_logo_lighter") || product.imageUrl?.includes("kk_his_hers_watch") ? "object-contain p-3" : "object-cover"} w-full h-full`}
            data-testid="img-product-detail"
          />
          {soldOut && (
            <div
