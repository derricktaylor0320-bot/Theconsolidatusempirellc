    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-12">
      {productList.map((product: any) => (
        <ProductCard 
          ...
          imageFit={product.imageUrl?.includes("kk_sneaker") || product.imageUrl?.includes("kk_air_genesis") || product.imageUrl?.includes("kk_air_spectrum") || product.imageUrl?.includes("kk_air_nitrogen") || product.imageUrl?.includes("kk_signature_crest") || product.imageUrl?.includes("kk_crest_2_high") || product.imageUrl?.includes("kk_monarch_vanguard") || product.imageUrl?.includes("kk_sovereign_runner") || product.imageUrl?.includes("kk_classic_leather_foundation") || product.imageUrl?.includes("kk_tundra_chukka") || product.imageUrl?.includes("kk_tundra_fur_chukka") || product.imageUrl?.includes("kk_canvas_essential") || product.imageUrl?.includes("kk_classic_white_high_tops") || product.imageUrl?.includes("kk_black_gold_high_tops") || product.imageUrl?.includes("kk_custom_logo_jeans") || product.imageUrl?.includes("kk_custom_logo_shorts") || product.imageUrl?.includes("kk_custom_logo_bikini") || product.imageUrl?.includes("kk_branded_logo_lighter") ? "contain" : "cover"}
        />
      ))}
    </div>
  );
